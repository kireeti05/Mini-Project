...
<FORM Name="AddProj" ACTION="AddProject.jsp" onsubmit="return validate()">
	...
	<TR class=row_odd>
		...
		<TD><Input type="date" name='DealDate' value=''>
	...
	<TR>
		...
		<!-- <img onkeypress="fnCalendar(this)" id="imgDate" style="CURSOR: hand" onClick="fnCalendar(this)" height="16" src="Images/CalDis.gif" width="16" border="0" name="imgDate" onMouseOver="fnEnableCalLookup(this)" onMouseOut="fnDisableCalLookup(this)" > --></TR>
	<TR class=row_odd>
